...
//    private Katalog katalog;
    ...
    public Produkt(int produktID, String bezeichnung, String beschreibung, double preis, ProduktKategorie produktKategorie, AccountDTO anbietenderAccountDTO, int bestand) {
