...
//    private int anzahlProdukte = 0; // Soll nur Produkte mit verschiedenen ProduktDTO-IDs berücksichtigen
...
//
////        for (Iterator<ProduktDTO> it = produkte.iterator(); it.hasNext();){
////            ProduktDTO produkte = it.next();          //ProduktDTO produkte checken
...
//            if(ekwp.equals(p) && ekwp.getProduktDTO().getBestand() >= anzahl) {
...
//            sum += ekwp.getProduktDTO().getPreis() * ekwp.getAnzahl();
//        }
//        return sum;
//    }
//
